...
export default class Markdown extends React.Component {
  constructor(props) {
    ...
    this.rules = (this.props.customRules || {}).concat(Rules)
    this.customElementsRenderer = this.props.customElementsRenderer || function () {}
  }
  ...
  compileFragment (fragment) {
    if (fragment) {
      this.i += 1
      return <Elements key={this.i} fragment={fragment} renderString={this.renderString} compileFragment={this.compileFragment} i={this.i} args={this.props.args} customElementsRenderer={this.customElementsRenderer} />
    } else {
      return null
    }
  }
