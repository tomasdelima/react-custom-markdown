...
export default class Markdown extends React.Component {
  ...
  compileFragment (fragment) {
    if (fragment) {
      this.i += 1
      return <Elements key={this.i} fragment={fragment} renderString={this.renderString} compileFragment={this.compileFragment} i={this.i} customElementsRenderer={this.customElementsRenderer} />
    } else {
      return null
    }
  }
